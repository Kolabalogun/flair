  ...
  const submitLikes = async () => {
    try {
      ...
      const updatedForm = {
        ...
        likes: updateLikes,
        collectionId: posts[0]?.$collectionId,
      };
  ...
  return (
    <SafeAreaView className="bg-primary h-full">
      ...
      <ScrollView className="px-4 my-5">
        <View>
          <Text className="text-white mb-3 font-psemibold text-3xl">
            {posts[0]?.title}
          </Text>
        </View>
        ...
        <View className="mt-3 mb-1 mx-1 flex-row gap-x-3 items-center">
